...
5. Call `get_granola_meetings` and filter for client-related meetings

**If $ARGUMENTS looks like a project name/key:**
1. Call `get_project` with the project key/name
2. Call `get_phases` to see project phases
3. Call `get_tasks` filtered by project to see active work
