...
Save a crystallized summary of our conversation about voice notes. Use the LifeOS MCP tools.
...
**Then save using:** Call create_ai_convo_summary with the extracted data (title, summary, keyInsights, actionItems, ideas, tags, summaryType, conversationContext).
