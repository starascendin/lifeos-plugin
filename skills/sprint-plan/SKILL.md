---
name: sprint-plan
description: Plan the current sprint/current cycle and apply mutations to cycle goals, task assignments, priorities, due dates, and issue calendar blocks
---
...
2. Build a cycle plan:
   ...
   - Assign near-term work to days or deadlines with `dueDate`.
