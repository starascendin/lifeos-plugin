---
name: falkor-graph
description: Query and link LifeOS PPV data through the FalkorDB sidecar graph. Use when the user asks for Cypher graph traversal, FalkorDB graph inspection, or agent-owned links over PPV visions, pillars, identities, and projects.
---
...
1. Call `falkor_graph_schema` first.
   ...
   - Review allowed node labels, relationship types, and examples.
