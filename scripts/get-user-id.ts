 ...
 *
 * Usage:
 *   npx tsx packages/lifeos-plugin/scripts/get-user-id.ts [email]
 *
 * Environment:
 *   CONVEX_URL - Convex deployment URL (defaults to dev)
 *
 * Examples:
 *   npx tsx packages/lifeos-plugin/scripts/get-user-id.ts bryanshliu@gmail.com
 *   CONVEX_URL=https://ideal-cheetah-690.convex.cloud npx tsx packages/lifeos-plugin/scripts/get-user-id.ts bryanshliu@gmail.com
 */

// Configuration
const DEFAULT_EMAIL = "bryanshliu@gmail.com";
const CONVEX_URLS = {
  dev: "https://ideal-cheetah-690.convex.cloud",
  prod: "https://ideal-cheetah-690.convex.cloud",
};
  ...
  if (userId) {
    ...
    console.log(JSON.stringify({
      mcpServers: {
        lifeos: {
          command: "npx",
          args: ["tsx", "packages/lifeos-plugin/src/index.ts"],
          env: {
